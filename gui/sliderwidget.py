...
class ScaleDelegator(type(Gtk.Bin)):
    ...
    The purpose of this is to allow setting properties on ScaleWithEntry
...
class ScaleWithEntry (with_metaclass(ScaleDelegator, Gtk.Bin)):
    ...
    def __init__(self, adj=None):
        super(ScaleWithEntry, self).__init__()
